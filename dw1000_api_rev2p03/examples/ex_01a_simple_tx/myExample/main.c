...
int main(void)
{
    ...
    while(1)
    {
        //printf("Setting to idle mode\n");
        /* Write frame data to DW1000 and prepare transmission. See NOTE 4 below.*/
        int res = dwt_writetxdata(sizeof(tx_msg), tx_msg, 0); /* Zero offset in TX buffer. */
        printf("dwt_writetxdata return %d\n", res);
        ...
        deca_sleep(TX_DELAY_MS);//sleep_ms(TX_DELAY_MS);
